...
public final class Sqrt extends expression.types.LeftOp implements tom.library.sl.Visitable  {
  ...
  private static Sqrt gomProto = (Sqrt) factory.build(new Sqrt());
