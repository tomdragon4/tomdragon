...
public final class Op extends expression.types.Op implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Op";


  private Op() {}
  private int hashCode;
  private static Op gomProto = new Op();
    private expression.types.LeftOp _Ope3;

  /**
   * Constructor that builds a term rooted by Op
   *
   * @return a term rooted by Op
   */

  public static Op make(expression.types.LeftOp _Ope3) {

    // use the proto as a model
    gomProto.initHashCode( _Ope3);
    return (Op) factory.build(gomProto);
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Op and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
   ...
   //Op interface
  /**
   * Returns true if the term is rooted by the symbol Op
   *
   * @return true, because this is rooted by Op
   */
  @Override
  public boolean isOp() {
    return true;
